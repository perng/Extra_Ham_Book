...
\begin{figure}[h]
    \centering
    % \includegraphics[width=0.8\textwidth]{fig:capacitor-circuit}
    \caption{Capacitor in a circuit with electric field representation.}
    \label{fig:capacitor-circuit}
    % Prompt: Diagram showing a capacitor in a circuit and its electric field.
    % The figure should include a simple circuit with a capacitor, showing the electric field lines between the plates.
\end{figure}
