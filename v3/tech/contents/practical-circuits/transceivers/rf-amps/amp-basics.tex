...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.8\textwidth]{transceiver-diagram}
    ...
    % Image prompt: Diagram of a transceiver showing the integration of receiver and transmitter components.
\end{figure}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.8\textwidth]{vhf-amp-switch}
    \caption{Illustration of a VHF power amplifier with the SSB/CW-FM switch highlighted.}
    \label{fig:vhf-amp-switch}
    % Image prompt: Illustration of a VHF power amplifier with the SSB/CW-FM switch highlighted.
\end{figure}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.8\textwidth]{rf-power-amp-diagram}
    ...
    % Image prompt: Block diagram showing the placement of an RF power amplifier in a transceiver setup.
\end{figure}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.8\textwidth]{rf-preamplifier-installation}
    ...
    % Image prompt: Diagram showing the installation of an RF preamplifier between the antenna and receiver.
\end{figure}
